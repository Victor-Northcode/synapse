...
здесь — только за игру и ролики): цели дня (+1 каждая), вехи серии
(3/7/14 дней), финал главы (+5), мастерство на «очень сложных» связях,
повышение уровня оператора (+2), ролик (+1, до 3 в день). Быстро
нафармить нельзя — это осознанно. Стоки: бустеры (4–8✦), подсказки
(6✦+), мастерская (40–340✦, навсегда), темы (14–30✦).
